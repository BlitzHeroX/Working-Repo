...
bool check_linear(int guess, int answer, int& score)        //added reference int score
{
    if(guess == answer)
    {
        cout << "Great!\n\n";
        score++;                                            //score increase by 1 if correct
        return true;                                        //return bool check_linear as true
    }
...
bool check_quadratic(int guess1, int guess2, int answer1, int answer2, int& score)
{
    if((guess1 != guess2) && (guess1 == answer1 || guess1 == answer2) && (guess2 == answer1 || guess2 == answer2))
    {
        cout << "Great!\n\n";
        score++;                                            //score increase by 1 if correct
        return true;                                        //return bool check_quadratic as true
    }

    else
    {
        cout << "Oops! The solution was " << answer1 << " or " << answer2 << ".\n\n";
        return false;
    }
...
int main()
{
    ...
    while(reply == 'L' || reply == 'Q')
    {
        ...
        else
        {
            ...
            check_quadratic(x, y, solution1, solution2, score);
        }
